# Generated by Django 3.0.8 on 2020-08-19 02:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('form_type', models.CharField(blank=True, choices=[('le', 'Leave Early'), ('lo', 'Leave Out'), ('il', 'In Late')], default='rp', help_text='Form type', max_length=2)),
        ...
        migrations.AddField(
            model_name='user',
            name='division',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='drs.Division'),
        ),
        migrations.AddField(
            model_name='user',
            name='groups',
        ...
        migrations.AddField(
            model_name='user',
            name='manager',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='manager_user', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='user',
            name='position',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='drs.Position'),
        ),
        migrations.AddField(
            model_name='user',
            name='skill',
            field=models.ManyToManyField(help_text='Your skills', to='drs.Skill'),
        ),
        migrations.AddField(
            model_name='user',
